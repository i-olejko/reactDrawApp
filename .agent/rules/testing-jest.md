...
# React Testing Strategy: Jest

## 1. Testing Framework
- **Use Jest:** All tests should be written using Jest as the primary testing framework.
...
- **Avoid end-to-end tests in Jest:** Use dedicated tools (e.g., Cypress, Playwright) for E2E.
...
## 5. Mocking
- **Mock external dependencies:** Use Jest's mocking features for APIs, modules, and timers.
